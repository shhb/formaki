...
public class PurchaseOrderItemDTO implements Serializable {
  ...
  private String qtyOrdered; //needed
  ...
  /** warehouse location * /
  private String binCode; //optional
  private String binLocation ; //optional
  private String warehouseCode; //optional
  private String warehouseLocation; //optional
  private String casePack; //optional
  */
