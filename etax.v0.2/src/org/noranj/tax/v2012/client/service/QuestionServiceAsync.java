...
public interface QuestionServiceAsync {
   ...
   * @return
   */
  public void getListOfQuestions(ApplicantDTO applicant, QuestionCategoryType /*income, deduction, province...)*/ simplifiedCategoryType, AsyncCallback<Map<String, QuestionSettingsDTO>> callback);
